...
| `variables`           | object[] | false     |                          | Variables to be passed into the template file.                                                                                                                                                                                                                                                                                  |
...
| `resourceFiles`       | string[] | false     |                          | Zero or more resource files, , relative to the _input_ directory. Resource files may be expressed as [glob patterns](https://en.wikipedia.org/wiki/Glob_(programming)). Resource files are copied to the output directory with their relative paths preserved.                                                                  |
