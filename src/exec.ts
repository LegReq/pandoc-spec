...
const extendedFlags: Record<keyof Options, AnyExtendedFlag> = {
    ...
    debug: {
        type: "boolean",
        description: "If set, dumps the input and output directory and the Pandoc command-line to stderr prior to execution."
    },
    verbose: {
        type: "boolean",
        description: "If set, passes --verbose to Pandoc for verbose output."
    },
    autoDate: {
        type: "boolean",
        description: "If set, adds a `date` value to the metadata in the format YYYY-MM-DD."
    },
    inputFormat: {
        type: "string",
    ...
    numberSections: {
        type: "boolean",
        description: "If set, sections are numbered automatically."
    },
    generateTOC: {
        type: "boolean",
        description: "If set, a table of contents is generated from the headings."
    },
    filters: {
        type: "string",
        isMultiple: true,
    ...
    cleanOutput: {
        type: "boolean",
        description: "If set, the output directory is cleaned before Pandoc is run."
    },
    outputFile: {
        type: "string",
...
export function exec(): never {
    ...
    process.exit(pandocSpec(options));
}
